...
For this exercise, load the log file (put it in the directory `data` in the `src` directory of the day) into a dataframe, change the delimiter, and save it to a different file.
